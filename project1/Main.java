...
public class Main {
    public static void main(String[] args) {
        ...
        Optional<ShareInfo> highShare = PickShareFunctional.findHighPriced(Shares.symbols.parallelStream());

        long endTime1 = System.currentTimeMillis();

        // Optional<ShareInfo> highShareParallel =
        ...
        // }
        // System.out.println(
        // "Time execution of findHighPriced(Shares.symbols.parallelStream()) = " +
